...
/* WEBPACK VAR INJECTION */(function(process) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createClient", function() { return c; });
...
function fetch_images(query, page) {
  var client = Object(pexels__WEBPACK_IMPORTED_MODULE_0__["createClient"])('563492ad6f917000010000019609d48f2516484d8c404f689fcb234f');
  client.photos.search({
    ...
    console.log(res);
    var images = $('.img-result').html();
    res.photos.forEach(function (photo) {
      images = images + "<img class=\"make-it-bg img-fluid img-thumbnail m-1\" src=\"".concat(photo.src.small, "\" data-landscape=\"").concat(photo.src.landscape, "\" alt=\"\">");
    });
    $('.img-result').html(images);
    $('.load-more-img').attr('data-page', res.page + 1);
    $('.load-more-img').removeClass('d-none');
  });
}

$('.img-keyword').keypress(function (e) {
  if (e.which == '13') {
    e.preventDefault();
    fetch_images($(this).val(), 1);
  }
});
/**
 * On Search
...
$(function () {
  $('form.image-search').on('submit', function (e) {
    e.preventDefault();
    var query = $('.img-keyword').val();
    fetch_images(query, 1);
  });
});
/**
 * Load more images
...
$(document).on('click', '.load-more-img', function (e) {
  var page = $(this).data('page');
  var query = $('.img-keyword').val();
  fetch_images(query, page);
});
/**
 * Change Background on clicking image
 */

$(document).on('click', '.make-it-bg', function (e) {
  var img_src = $(this).data('landscape');
  console.log(img_src);
  $('.card-ui-view').css('background-image', "linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(".concat(img_src, ")"));
...
/***/ 3:
/*!***************************************!*\
  !*** multi ./resources/js/ui-view.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /media/suman/ShareDrive/Project/GKPress/resources/js/ui-view.js */"./resources/js/ui-view.js");
